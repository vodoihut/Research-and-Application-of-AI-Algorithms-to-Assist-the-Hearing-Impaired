...
count = len(oss.listdir("C:\\Users\\hieu\\PycharmProjects\\handsign\\data_hieu\\daurau\\"))
c_dir = 'daurau'
...
cv2.imwrite("C:\\Users\\hieu\\PycharmProjects\\handsign\\white.jpg",white)
...
while True:
    try:
        ...
        white = cv2.imread("C:\\Users\\hieu\\PycharmProjects\\handsign\\white.jpg")
        ...
        if interrupt & 0xFF == ord('n'):
            ...
            if ord(c_dir)==ord('Z')+1:
                c_dir='A'
            flag = False
            count = len(oss.listdir("C:\\Users\\hieu\\PycharmProjects\\handsign\\data_hieu\\" + (c_dir) + "\\"))
        ...
        if flag==True:
            ...
            if suv==180:
                flag=False
            if step%3==0:
                cv2.imwrite("C:\\Users\\hieu\\PycharmProjects\\handsign\\data_hieu\\" + (c_dir) + "\\" + str(count) + ".jpg",
                            skeleton1)
